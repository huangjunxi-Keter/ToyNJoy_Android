package com.example.toynjoy.uilts.alipay;
...
public class OrderInfoUtil2_0 {
	 ...
	 * 构造支付订单参数列表
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2, String product_code, String total_amount, String subject, String body) {
		Map<String, String> keyValues = new HashMap<String, String>();
